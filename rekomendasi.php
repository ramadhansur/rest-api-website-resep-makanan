<?php 
// Url Api
$urlRecommend = "https://masak-apa-tomorisakura.vercel.app/api/recipes";
...
<body>
        ...
        <ul class="menu">
            ...
            <li><a href="#">Article</a>
                <ul class="menu-3">
                    ...
                    ?>
                        <li><a href="<?= $row['key']; ?>"><?= $row['title']; ?></a></li>
                    <?php } ?>
                </ul>
            </li>
        </ul>
    ...
    <div class="all-tracks-head" style="margin-top: 100px;">
        <h2>Rekomendasi Hidangan</h2>
    </div>
    <section id="all-tracks" class="all-tracks">
        <?php foreach ($jsonDecodeRecomend['results'] as $row) {
        ?>
